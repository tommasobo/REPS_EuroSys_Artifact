...
def main(args):
    ...
    os.system("rm -r res/queue_size_normalized/")
    os.system("rm -r res/queue_phantom/")
    os.system("rm -r res/rtt/")
    os.system("rm -r res/cwd/")
    os.system("rm -r res/ecn/")
    os.system("rm -r res/sent/")
    os.system("rm -r res/nack/")
    os.system("rm -r res/acked/")
    os.system("rm -r res/fasti/")
    os.system("rm -r res/fastd/")
    os.system("rm -r res/mediumi/")
    os.system("rm -r res/trimmed_rtt/")
    os.system("rm -r res/ecn_rtt/")
    os.system("rm -r res/case1/")
    os.system("rm -r res/case2/")
    os.system("rm -r res/case3/")
    os.system("rm -r res/case4/")
    os.system("rm -r res/switch_failures/")
    os.system("rm -r res/cable_failures/")
    os.system("rm -r res/switch_drops/")
    os.system("rm -r res/cable_drops/")
    os.system("rm -r res/routing_failed_switch/")
    os.system("rm -r res/routing_failed_cable/")
    os.system("rm -r res/switch_degradations/")
    os.system("rm -r res/cable_degradations/")
    os.system("rm -r res/random_packet_drops/")


    os.system("mkdir -p res/queue_size_normalized/")
    os.system("mkdir -p res/queue_phantom/")
    os.system("mkdir -p res/rtt/")
    os.system("mkdir -p res/cwd/")
    os.system("mkdir -p res/ecn/")
    os.system("mkdir -p res/sent/")
    os.system("mkdir -p res/nack/")
    os.system("mkdir -p res/acked/")
    os.system("mkdir -p res/fasti/")
    os.system("mkdir -p res/fastd/")
    os.system("mkdir -p res/mediumi/")
    os.system("mkdir -p res/trimmed_rtt/")
    os.system("mkdir -p res/ecn_rtt/")
    os.system("mkdir -p res/case1/")
    os.system("mkdir -p res/case2/")
    os.system("mkdir -p res/case3/")
    os.system("mkdir -p res/case4/")
    os.system("mkdir -p res/switch_failures/")
    os.system("mkdir -p res/cable_failures/")
    os.system("mkdir -p res/switch_drops/")
    os.system("mkdir -p res/cable_drops/")
    os.system("mkdir -p res/routing_failed_switch/")
    os.system("mkdir -p res/routing_failed_cable/")
    os.system("mkdir -p res/switch_degradations/")
    os.system("mkdir -p res/cable_degradations/")
    os.system("mkdir -p res/random_packet_drops/")



    os.system("cp -a ../sim/datacenter/cwd/. res/cwd/")
    os.system("cp -a ../sim/datacenter/rtt/. res/rtt/")
    os.system("cp -a ../sim/datacenter/queue/. res/queue_size_normalized/")
    os.system("cp -a ../sim/datacenter/queue_phantom/. res/queue_phantom/")
    os.system("cp -a ../sim/datacenter/sent/. res/sent/")
    os.system("cp -a ../sim/datacenter/ecn/. res/ecn/")
    os.system("cp -a ../sim/datacenter/nack/. res/nack/")
    os.system("cp -a ../sim/datacenter/fasti/. res/fasti/")
    os.system("cp -a ../sim/datacenter/fastd/. res/fastd/")
    os.system("cp -a ../sim/datacenter/mediumi/. res/mediumi/")
    os.system("cp -a ../sim/datacenter/acked/. res/acked/")
    os.system("cp -a ../sim/datacenter/trimmed_rtt/. res/trimmed_rtt/")
    os.system("cp -a ../sim/datacenter/ecn_rtt/. res/ecn_rtt/")
    os.system("cp -a ../sim/datacenter/case1/. res/case1/")
    os.system("cp -a ../sim/datacenter/case2/. res/case2/")
    os.system("cp -a ../sim/datacenter/case3/. res/case3/")
    os.system("cp -a ../sim/datacenter/case4/. res/case4/")
    os.system("cp -a ../sim/datacenter/switch_drops/. res/switch_drops/")
    os.system("cp -a ../sim/datacenter/cable_drops/. res/cable_drops/")
    os.system("cp -a ../sim/datacenter/switch_failures/. res/switch_failures/")
    os.system("cp -a ../sim/datacenter/cable_failures/. res/cable_failures/")
    os.system("cp -a ../sim/datacenter/routing_failed_switch/. res/routing_failed_switch/")
    os.system("cp -a ../sim/datacenter/routing_failed_cable/. res/routing_failed_cable/")
    os.system("cp -a ../sim/datacenter/switch_degradations/. res/switch_degradations/")
    os.system("cp -a ../sim/datacenter/cable_degradations/. res/cable_degradations/")
    os.system("cp -a ../sim/datacenter/random_packet_drops/. res/random_packet_drops/")
    ...
    pathlist = Path('res/rtt').glob('**/*.txt')
    ...
    pathlist = Path('res/cwd').glob('**/*.txt')
    for files in sorted(pathlist):
        path_in_str = str(files)
    ...
    pathlist = Path('res/queue_phantom').glob('**/*.txt')
    ...
    pathlist = Path('res/queue_size_normalized').glob('**/*.txt')
    for files in natsort.natsorted(pathlist,reverse=False):
    ...
    pathlist = Path('res/ecn').glob('**/*.txt')
    for files in sorted(pathlist):
        path_in_str = str(files)
    ...
    if (args.show_case):
        ...
        pathlist = Path('res/case1').glob('**/*.txt')
        for files in natsort.natsorted(pathlist,reverse=False):
            path_in_str = str(files)
            temp_df30 = pd.read_csv(path_in_str, names=colnames, header=None, index_col=False, sep=',')
            name = [str(path_in_str)] * temp_df30.shape[0]
        ...
        pathlist = Path('res/case2').glob('**/*.txt')
        for files in natsort.natsorted(pathlist,reverse=False):
            path_in_str = str(files)
        ...
        saved_old_sum = 0
        pathlist = Path('res/case3').glob('**/*.txt')
        for files in natsort.natsorted(pathlist,reverse=False):
            path_in_str = str(files)
        ...
        pathlist = Path('res/case4').glob('**/*.txt')
        for files in natsort.natsorted(pathlist,reverse=False):
            path_in_str = str(files)
    ...
    pathlist = Path('res/nack').glob('**/*.txt')
    for files in sorted(pathlist):
        path_in_str = str(files)
    ...
    pathlist = Path('res/acked').glob('**/*.txt')
    for files in sorted(pathlist):
        path_in_str = str(files)
    ...
    pathlist = Path('res/ecn_rtt').glob('**/*.txt')
    for files in sorted(pathlist):
        path_in_str = str(files)
    ...
    pathlist = Path('res/trimmed_rtt').glob('**/*.txt')
    for files in sorted(pathlist):
        path_in_str = str(files)
    ...
    pathlist = Path('res/fasti').glob('**/*.txt')
    for files in sorted(pathlist):
        path_in_str = str(files)
    ...
    pathlist = Path('res/fastd').glob('**/*.txt')
    for files in sorted(pathlist):
        path_in_str = str(files)
    ...
    pathlist = Path('res/mediumi').glob('**/*.txt')
    for files in sorted(pathlist):
        path_in_str = str(files)
    ...
    pathlist = Path('res/switch_failures').glob('**/*.txt')
    for files in sorted(pathlist):
        path_in_str = str(files)
    ...
    pathlist = Path('res/cable_failures').glob('**/*.txt')
    for files in sorted(pathlist):
        path_in_str = str(files)
        temp = pd.read_csv(path_in_str, names=colnames, header=None, index_col=False, sep=',')
    ...
    pathlist = Path('res/switch_drops').glob('**/*.txt')
    for files in sorted(pathlist):
        path_in_str = str(files)
        temp = pd.read_csv(path_in_str, names=colnames, header=None, index_col=False, sep=',')
    ...
    pathlist = Path('res/cable_drops').glob('**/*.txt')
    for files in sorted(pathlist):
        path_in_str = str(files)
        temp = pd.read_csv(path_in_str, names=colnames, header=None, index_col=False, sep=',')
    ...
    pathlist = Path('res/switch_degradations').glob('**/*.txt')
    for files in sorted(pathlist):
        path_in_str = str(files)
        temp = pd.read_csv(path_in_str, names=colnames, header=None, index_col=False, sep=',')
    ...
    pathlist = Path('res/cable_degradations').glob('**/*.txt')
    for files in sorted(pathlist):
        path_in_str = str(files)
        temp = pd.read_csv(path_in_str, names=colnames, header=None, index_col=False, sep=',')
    ...
    pathlist = Path('res/random_packet_drops').glob('**/*.txt')
    for files in sorted(pathlist):
        path_in_str = str(files)
        temp = pd.read_csv(path_in_str, names=colnames, header=None, index_col=False, sep=',')
