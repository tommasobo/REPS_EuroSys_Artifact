...
TIME_INTERVAL_NS = 50000  # Time interval in nanoseconds
...
pattern = r"LS0->US(\d+)"
# Input file path
file_pathreps = 'input_data/repsportSwitch_LowerPod_{}_.txt'.format(ls_number)
file_pathobs = 'input_data/obsportSwitch_LowerPod_{}_.txt'.format(ls_number)

queue_folder = 'input_data/'
...
plt.savefig("combined_plot_as.png", bbox_inches='tight')
plt.savefig("combined_plot_as.pdf", bbox_inches='tight')
plt.show()
