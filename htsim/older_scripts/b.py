...
TIME_INTERVAL_NS = 1000  # Time interval in nanoseconds
...
pattern = r"LS0->US(\d+)"
pattern = r"Switch_UpperPod_(\d+)"
# Input file path
file_path = '../sim/datacenter/link_util/link_utilSwitch_LowerPod_{}_.txt'.format(ls_number)
