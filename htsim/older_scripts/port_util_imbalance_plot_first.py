...
pattern = r"LS0->US(\d+)"
# Input file path
file_pathreps = 'input_data_first/portSwitch_LowerPod_{}_.txt'.format(ls_number)
file_pathobs = 'input_data_first/obsportSwitch_LowerPod_{}_.txt'.format(ls_number)

queue_folder = 'input_data_first/'
