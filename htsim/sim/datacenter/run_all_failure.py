...
save_folder = output_folder + "_figures"
plot_only = True
...
# Plotting
os.system(f"python3 plot_failures.py --text 'Speedup vs OPS' --input_folder_exp {output_folder}fail_notrim_synth --name notrim_fail_synth --dont_show --save_folder {save_folder}")
...
# Plotting
os.system(f"python3 plot_failures.py --text 'Speedup vs OPS (Avg FCT)' --input_folder_exp {output_folder}fail_notrim_dc --name notrim_fail_dc --dont_show --save_folder {save_folder}")
...
if not plot_only:
    ...
    print("DC Trimming Done")
# Plotting
os.system(f"python3 plot_failures.py --text 'Speedup vs OPS' --input_folder_exp {output_folder}fail_notrim_allred --name notrim_fail_coll --dont_show --save_folder {save_folder}")
