...
for directory in [
    "../artifact_results",
    "../artifact_results/fig_13_queue_ballsbins",
    "../artifact_results/fig_13_queue_ballsbins/data",
    "../artifact_results/fig_13_queue_ballsbins/plots"
]:
...
plt.savefig("../artifact_results/fig_13_queue_ballsbins/plots/queue_evolution_ports.png", bbox_inches='tight')
plt.savefig("../artifact_results/fig_13_queue_ballsbins/plots/queue_evolution_ports.pdf", bbox_inches='tight')
