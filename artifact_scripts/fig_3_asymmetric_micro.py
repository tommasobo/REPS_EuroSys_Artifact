...
for directory in [
    "../artifact_results",
    "../artifact_results/fig_3_asymmetric_micro",
    "../artifact_results/fig_3_asymmetric_micro/data",
    "../artifact_results/fig_3_asymmetric_micro/plots"
]:
...
os.system("../htsim/sim/datacenter/htsim_uec -failed 1 -save_data_folder ../artifact_results/fig_3_asymmetric_micro/raw_output -sack_threshold 4000 -end 90000 -seed 5 -paths 65535 -sender_cc_only -sender_cc_algo mprdma -topo ../htsim/sim/datacenter/topologies/reps/fat_tree_128_1os_3t_400g.topo -linkspeed 400000 -ecn 20 80 -q 100 -cwnd 151 -load_balancing_algo freezing -log_link -tm ../htsim/sim/datacenter/connection_matrices/test_symm32.cm -collect_data > out.tmp")
os.system("cp ../artifact_results/fig_3_asymmetric_micro/raw_output/port/portSwitch_LowerPod_0_.txt ../artifact_results/fig_3_asymmetric_micro/data/portSwitch_LowerPod_0_.txt")
os.system("cp ../artifact_results/fig_3_asymmetric_micro/raw_output/queueSize/queueSizeLS0-\>US0.txt ../artifact_results/fig_3_asymmetric_micro/data/queueSizeLS0-\>US0.txt")
os.system("cp ../artifact_results/fig_3_asymmetric_micro/raw_output/queueSize/queueSizeLS0-\>US1.txt ../artifact_results/fig_3_asymmetric_micro/data/queueSizeLS0-\>US1.txt")
os.system("cp ../artifact_results/fig_3_asymmetric_micro/raw_output/queueSize/queueSizeLS0-\>US2.txt ../artifact_results/fig_3_asymmetric_micro/data/queueSizeLS0-\>US2.txt")
os.system("cp ../artifact_results/fig_3_asymmetric_micro/raw_output/queueSize/queueSizeLS0-\>US3.txt ../artifact_results/fig_3_asymmetric_micro/data/queueSizeLS0-\>US3.txt")
\
...
os.system("cp ../artifact_results/fig_3_asymmetric_micro/raw_output/port/portSwitch_LowerPod_0_.txt ../artifact_results/fig_3_asymmetric_micro/data/obsportSwitch_LowerPod_0_.txt")
os.system("cp ../artifact_results/fig_3_asymmetric_micro/raw_output/queueSize/queueSizeLS0-\>US0.txt ../artifact_results/fig_3_asymmetric_micro/data/obsqueueSizeLS0-\>US0.txt")
os.system("cp ../artifact_results/fig_3_asymmetric_micro/raw_output/queueSize/queueSizeLS0-\>US1.txt ../artifact_results/fig_3_asymmetric_micro/data/obsqueueSizeLS0-\>US1.txt")
os.system("cp ../artifact_results/fig_3_asymmetric_micro/raw_output/queueSize/queueSizeLS0-\>US2.txt ../artifact_results/fig_3_asymmetric_micro/data/obsqueueSizeLS0-\>US2.txt")
os.system("cp ../artifact_results/fig_3_asymmetric_micro/raw_output/queueSize/queueSizeLS0-\>US3.txt ../artifact_results/fig_3_asymmetric_micro/data/obsqueueSizeLS0-\>US3.txt")


pattern = r"LS0->US(\d+)"
# Input file path
file_pathreps = '../artifact_results/fig_3_asymmetric_micro/data/portSwitch_LowerPod_{}_.txt'.format(ls_number)
file_pathobs = '../artifact_results/fig_3_asymmetric_micro/data/obsportSwitch_LowerPod_{}_.txt'.format(ls_number)
queue_folder = '../artifact_results/fig_3_asymmetric_micro/data/'
...
plt.savefig("../artifact_results/fig_3_asymmetric_micro/plots/asymmetric_micro.png", bbox_inches='tight')
plt.savefig("../artifact_results/fig_3_asymmetric_micro/plots/asymmetric_micro.pdf", bbox_inches='tight')
